...
namespace PractisingForm
{
    ...
    public partial class CatagoryChittagong3 : Form
    {
        ...
        private void CatagoryChittagong3_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
