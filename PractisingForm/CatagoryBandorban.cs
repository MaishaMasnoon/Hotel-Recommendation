...
{
    public partial class CatagoryBandorban : Form
    {  
        ...
        private void CatagoryBandorban_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            /*string CI = dateTimePicker1.Value.ToShortDateString();
            string CO = dateTimePicker2.Value.ToShortDateString();

           SqlDataAdapter a = new SqlDataAdapter("Select RoomCatagory.Id,RoomNumber.* from RoomCatagory,RoomNumber Where RoomCatagory.Id=14 AND RoomCatagory.Id=RoomNumber.RoomCatagoryId", con);
            DataTable da = new DataTable();
            ...
            foreach (DataRow row in da.Rows)
            {
                ...
                RoomNumber rn1 = db.RoomNumbers.SingleOrDefault(x => x.Check_In.Value.ToString() == CI);

                RoomNumber rn2 = db.RoomNumbers.SingleOrDefault(x => x.Check_Out.Value.ToString() == CO);

                if (rn1 == null && rn2 == null)
                {

                    MessageBox.Show("Reservation Succhessfull!");

                }
                else {
                    MessageBox.Show("MessageBox.Show("For Reservation Please Call : 02-8829293 or email : hrs@gmail.com!");
                }
        ...
        private void CatagoryBandorban_Load(object sender, EventArgs e)
        {
