...
{
    public partial class CatagoryChittagong1 : Form
    {
        ...
        public CatagoryChittagong1()
        {
            InitializeComponent();
        }

        private void CatagoryChittagong1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
