...
{
    public partial class CatagoryChittagong : Form
    {
        ...
        private void CatagoryChittagong_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void CatagoryChittagong_Load(object sender, EventArgs e)
        {
